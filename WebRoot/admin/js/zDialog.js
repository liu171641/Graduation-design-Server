/**
 * zDialog 2.0   窗体边框背景#3c95c8;
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = 'admin/images/'; //图片路径配置
...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="7" height="33" style="background-color:#3c95c8; !important;background-color:#3c95c8;"><div style="width: 7px;"></div></td>\
      <td height="33" style="background-color:#3c95c8; !important;background-color:#3c95c8;"><div style="padding: 9px 0 0 4px; float: left; font-weight: bold; color:#fff;"><img align="absmiddle" src="' + IMAGESPATH + 'icon_dialog.gif"/><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
      ...
      <td width="7" height="33" style="background-color:#3c95c8 !important;background-color:#3c95c8;"><div style="width: 7px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="7" style="background-color:#3c95c8; !important;background-color:#3c95c8;"></td>\
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          <tr id="_MessageRow_' + this.ID + '" style="' + (this.ShowMessageRow ? "" : "display:none") + '">\
            <td valign="top" height="50"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#3c95c8;" id="_MessageTable_' + this.ID + '">\
                <tr>\
                  <td width="50" height="50" align="center" style="background-color:#73c6e9;"><img width="32" height="32" src="' + IMAGESPATH + this.MessageIcon + '" id="_MessageIcon_' + this.ID + '"/></td>\
                  <td align="left" style="line-height: 16px; background-color:#73c6e9;"><div id="_MessageTitle_' + this.ID + '" style="font-weight:bold; background-color:#73c6e9;">' + this.MessageTitle + '</div>\
	...
	' + (function (obj) {
      ...
      <td width="7" style="background-color:#3c95c8; !background-color:#3c95c8;"></td>\
    </tr>\
    <tr>\
      <td width="7" height="7" style="background-color:#3c95c8; !important;background-color:#3c95c8;"></td>\
      <td style="background-color:#3c95c8; !important;background-color:#3c95c8;"></td>\
      <td width="7" height="7" style="background-color:#3c95c8; !background-color:#3c95c8;"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
'
